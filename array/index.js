...
// // // // fruit.splice(1, 2, 'berry', 'banana', [1,2]);
// // // // console.log(fruit);
...
// // // // console.log(fruit);
// // // // console.log(fruit.push('avacado'));
// // // // console.log(fruit);
// // // // // fruit.shift();
// // // // console.log(fruit);
...
// // // 		this.lname = lastName;
// // // 	}
// // // 	let intro = new MyIntro('sajen', 'maharjan');
...
// let fruits = ['apple', 'banana', 'cherry', 'mango', 'lichi'];
// let citrus = fruits.slice(1, 3);
// console.log(fruits);
// console.log(citrus);

// fruits.splice(0, fruits.length, 'hello' , 'world');
// console.log(fruits);